...
<head>
<meta charset="utf-8" />
<title>Purchase   | <?php echo $_SESSION['userName']?> </title>
...
<script>
        ...
        $(add_button1).click(function(e){
            ...
            if(x < max_fields1){ 
                x++; 
                $(wrapper1).append('<div class="d-flex gap-2"><tbody class="list form-check-all"> <td> <div class="form-group" id=""> <select id="" class="form-select" name="" style="width:160px" required> <option value="">Select Metal</option> <option value="">Metal1</option> <option value="">Metal2</option> </select> </div> </td> <td> <select id="" class="form-select" name="" style="width:160px" required> <option value="">Select Type</option> <option value="">Type1</option> <option value="">Type2</option> </select> </td> <td> <select id="" class="form-select" name="" style="width:160px" required> <option value="">Select Size</option> <option value="">Size1</option> <option value="">Size2</option> </select> </td> <td> <div class="form-group" id=""> <input type="text" class="form-control" name="" id="" placeholder="No. of Reel" style="width:120px" required /> </div> </td> <td><div class="form-group" id=""> <input type="text" class="form-control" name="" id="" placeholder="Gross Wt." style="width:120px" required /> </div></td> <td><div class="form-group" id=""> <input type="text" class="form-control" name="" placeholder="Road Rate" style="width:120px" required/> </div> </td> <td><div class="form-group" id=""> <input type="text" class="form-control" name="" placeholder="Drawing" style="width:120px" required/> </div> </td> </tr> </tbody><a class="btn btn-sm btn-success edit-item-btn add_form_field1 delete">Remove</a></div>'); 
               //alert('Fields added');
            }
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              ...
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  ...
                  <li class="breadcrumb-item active">Purchase  Details & Form</li>
                </ol>
              </div>
            </div>
          </div>
            ...
            <div class="col-xxl-12">
              <div class="card">
                <div class="card-header align-items-center d-flex">
                  <h4 class="card-title mb-0 flex-grow-1">Add Purchase Entry</h4>
                </div>
                <!-- end card header -->
                <div class="card-body">
                    ...
                    <form action="" method="post">
                      ...
                      <div class="col-lg-4">
                        <div class="mb-4">
                          ...
                          <select id="" name="" class="form-select"  required>
                            ...
                            <option name="" value="">Account1</option>
                            <option name="" value="">Account2</option>
                            <option name="" value="">Account3</option>
                          </select>
                        </div>
                      </div>
                      <!--end col-->
                       <div class="col-lg-4">
                        <div class="mb-4">
                          ...
                          <input type="text" class="form-control" name="" placeholder="Voucher No."  id="" required/>
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-4">
                        <div class="mb-4">
                          ...
                          <input type="date" class="form-control" name="" placeholder=""  id="" required/>
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-4">
                        <div class="mb-4">
                          ...
                          <input type="text" class="form-control" name="" placeholder="Invoice No."   required/>
                        </div>
                      </div>
                      <!--end col-->
                       <div class="col-lg-4">
                        <div class="mb-4">
                          ...
                          <input type="text" class="form-control" name="" placeholder="Remarks" required/>
                        </div>
                      </div>
                      <!--end col-->
                       </div>
                      ...
                      <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <td>
                            <div class="form-group" id="">
                              <select id="" class="form-select" name="" style="width:160px"  required>
                                <option value="">Select Metal</option>
                                <option value="">Metal1</option>
                                 <option value="">Metal2</option>
                              </select>
                            </div>
                        </td>
                          <td>
                          ...
                          <td>
                            <div class="form-group" id="">
                              <input type="text" class="form-control" name="" id="" placeholder="No. of Reel" style="width:120px"  required />
                            </div>
                          </td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" id="" placeholder="Gross Wt."  style="width:120px" required />
                            </div></td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Road Rate" style="width:120px"  required/>
                            </div>
                          </td>
                             <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Drawing" style="width:120px" required/>
                            </div>
                          </td>
                          <td><div class="d-flex">
                              <div class="edit">
                      ...
                      <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <tbody class="list form-check-all">
                          ...
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" id="" placeholder="No. of Reel"   required />
                            </div></td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Reel Wt."   required/>
                            </div>
                          </td>
                             <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Net Weight"  required/>
                            </div>
                          </td>
                          <td><div class="d-flex">
                              <div class="edit">
                      ...
                      <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <tbody class="list form-check-all">
                          <td>
                            <div class="form-group" id="">
                              <input type="text" class="form-control" name="" id="" placeholder="Total Amount"   required />
                            </div>
                          </td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" id="" placeholder="Interest"   required />
                            </div></td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Net Amount"  required/>
                            </div>
                          </td>
                          <td><div class="d-flex">
                              <div class="edit">
