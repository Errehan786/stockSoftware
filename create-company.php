...
if(isset($_REQUEST['v_submit'])){
    ...
    $v_remark = $_REQUEST['v_remark'];
    $reg_id = $currentTime;
    $pass = addslashes($_REQUEST['v_password']);
    $password = addslashes(sha1($_REQUEST['v_password']));
    
    $sql = "INSERT INTO `company`(`reg_id`, `name`, `email`, `mobile_no`, `address`, `remark`,`password`,`pass`) VALUES ('$reg_id','$v_name','$v_email','$v_number','$v_address','$v_remark','$password','$pass')";
                                            ...
                                            <div class="col-lg-9 col-12">
                                                <div class="d-flex justify-content-end align-items-center h-100">
                                                    <a href="#addNewCategory">
                                                        <button class="btn btn-sm btn-success edit-item-btn"> Add New Company</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <table class="table align-middle table-nowrap" id="customerTable">
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        <?php while ($row = $result->fetch(PDO::FETCH_ASSOC)) { ?>
                                                            ...
                                                            <?php
                                                                // echo "<td>" . $row['id'] . "</td>";
                                                                echo "<td>" . $row['name']."<br><b style='font-size: 15px;'>R</b>". $row['reg_id'] . "</td>";
                                                                echo "<td>" . $row['email'] . "</td>";
                                                                echo "<td>" . $row['mobile_no'] . "</td>";
                                                                echo "<td>" . $row['pass'] . "</td>";
                                                                echo "<td>" . $row['address'] . "</td>";
                                                                echo "<td>" . $row['remark'] . "</td>";
                                                                //echo "<td><a href='#' style='color: #088f7d;' target='_blank'>Click Here</a></td>";
                                                                echo '<td>
                                                           <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <a href="companyedit.php?id='.$row['id'].'" class="btn btn-sm btn-success edit-item-btn" name="edit_category_item">Edit</a>
                                                            </div>
                                                              <div class="remove">
                                             ...
                                             function dataVdelete<?php echo $row['id'] ?>(rowID){
                                              ...
                                              if(!r){
                                                  return false;
                                                        ...
                                                        var myData = "rid="+rowID+"&action=deleteCustomer";
                                                        //alert(myData);
                                                         jQuery.ajax({
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="v_name" placeholder="Enter Company Name" autocomplete="off" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" maxlength="10" minlength="10" class="form-control" placeholder="Your Mobile no" name="v_number" id="mobile_no" onkeyup="chkNos()" autocomplete="off" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label for="compnayNameinput" class="form-label" required>Password</label>
                                                        <input type="text" class="form-control" name="v_password" placeholder="Enter Password" autocomplete="off" required/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label for="compnayNameinput" class="form-label" required>Remark</label>
                                                        <input type="text" class="form-control" name="v_remark" placeholder="Enter Remark" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="col-lg-12">
