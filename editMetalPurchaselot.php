...
///get purchaseLotWise data
$purchaseLotWiseSql = "SELECT * FROM `purchaseLotWise` where id='$_REQUEST[MetalPurchaseId]'";
$purchaseLotWiseResult = $conn->query($purchaseLotWiseSql);
$purchaseLotWiseRow = $purchaseLotWiseResult->fetch(PDO::FETCH_ASSOC);
//get accounts
...
if (isset($_REQUEST['main_submit'])) {
	...
	$purchaseSql = "UPDATE `purchaseLotWise` 
                SET `partyAccount` = '$partyAccountName', 
                    ...
                    `rodRate` = '$rRateField', 
                    `drawing` = '$sizeField', 
                    `emptyDate` = '$currentDate', 
                    `emptyNoOfReel` = '$emptyNoOfReel', 
                    `reelWt` = '$reelWt', 
                    `netWeight` = '$netWeight', 
                    `totalAmount` = '$totalAmount', 
                    `interest` = '$interestField', 
                    `netAmount` = '$netAmtField'
                WHERE `id` = '$_REQUEST[MetalPurchaseId]'"; // Replace with the appropriate unique identifier

if ($result = $conn->exec($purchaseSql)) {
    echo '<script>alert("Data has been updated successfully!");window.location = "metalPurchaselot.php";</script>';
} else {
									...
									<form action="" method="post">
										<div class="row">
												...
												<div class="mb-4">
													...
													<select id="vendorList" name="partyAccountName" class="form-select" onChange="selectPartyAccount(this.value)" required>
														...
														<?php while ($accountData = $accountResult->fetch(PDO::FETCH_ASSOC)) { ?>
															<option value="<?php echo $accountData['accountName']; ?>"<?php if($purchaseLotWiseRow['partyAccount'] == $accountData['accountName']) echo "selected";?>><?php echo $accountData['accountName']; ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
											...
											<div class="col-lg-4">
												<div class="mb-4">
													...
													<select name="accountName" id="accountName" class="form-select" required>
														...
														<option value="<?php echo $purchaseLotWiseRow['accountName']; ?>"><?php echo $purchaseLotWiseRow['accountName']; ?></option>
													</select>
												</div>
											</div>
											<!--end col-->
											<div class="col-lg-4">
												<div class="mb-4">
													...
													<input type="text" class="form-control" name="voucherNo" placeholder="Enter V.No." value="<?php echo $purchaseLotWiseRow['voucherNo']; ?>" readonly />
												</div>
											</div>
											<!--end col-->
											<div class="col-lg-4">
												<div class="mb-4">
													...
													<input type="text" class="form-control" name="cDate" value="<?php echo $purchaseLotWiseRow['cDate']; ?>" required />
												</div>
											</div>
											<!--end col-->
											<div class="col-lg-4">
												<div class="mb-4">
													...
													<input type="text" class="form-control" name="invoiceNo" value="<?php echo $purchaseLotWiseRow['invoiceNo']; ?>" readonly />
												</div>
											</div>
											<!--end col-->
											<div class="col-lg-4">
												<div class="mb-4">
													...
													<input type="text" class="form-control" name="remark" value="<?php echo $purchaseLotWiseRow['remark']; ?>" />
												</div>
											</div>
											<!--end col-->
										</div>
																		...
																		<tr>
																				...
																				<div class="form-group">
																					...
																					<select id="typeList" name="metalType" class="form-select" onChange="createType(this.value)" style="width:150px;" required>
																						...
																						<?php while ($row = $result->fetch(PDO::FETCH_ASSOC)) { ?>
																							<option value="<?php echo $row['type']; ?>"<?php if($purchaseLotWiseRow['metal'] == $row['type']) echo "selected";?>>
																			...
																			<td>
																				<div class="form-group" id="textarea1">
																					<select id="iteamList0" class="form-select" name="type" style="width:150px;" required1>
																						...
																						<option value="Charak" <?php if($purchaseLotWiseRow['type'] == "Charak") echo "selected";?>>Charak</option>
																						<option value="Coil" <?php if($purchaseLotWiseRow['type'] == "Coil") echo "selected";?>>Coil</option>
																						<option value="Drum" <?php if($purchaseLotWiseRow['type'] == "Drum") echo "selected";?>>Drum</option>
																						<option value="P.Reel" <?php if($purchaseLotWiseRow['type'] == "P.Reel") echo "selected";?>>P.Reel</option>
																						<option value="Reel" <?php if($purchaseLotWiseRow['type'] == "Reel") echo "selected";?>>Reel</option>
																					</select>
																				</div>
																			</td>
																			<td>
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select id="sizeTypeList" name="sizeType" class="form-select" onChange="createSize(this.value)" style="width:150px;" required>
                                                                                        ...
                                                                                        <?php while ($row = $result->fetch(PDO::FETCH_ASSOC)) { ?>
                                                                                            <option value="<?php echo $row['size']; ?>"<?php if($purchaseLotWiseRow['typeSize'] == $row['size']) echo "selected";?>>
																			...
																			<td>
																				<div class="form-group" id="">
																					<input type="text" class="form-control" name="noOfReel" value="<?php echo $purchaseLotWiseRow['noOfReel']; ?>" required/>
																				</div>
																			</td>
																			<td>
																				<div class="form-group">
																					<input type="text" class="form-control" id="grossWt" name="grossWt" value="<?php echo $purchaseLotWiseRow['grossWt']; ?>"  required />
																				</div>
																			</td>
																			<td>
																				<div class="form-group" id="">
																					<input type="text" class="form-control" name="rRateField" id="rRateField" value="<?php echo $purchaseLotWiseRow['rodRate']; ?>" required />
																				</div>
																			</td>
																			<td>
																				<div class="form-group" id="">
																					<input type="text" class="form-control" name="sizeField" id="sizeField" value="<?php echo $purchaseLotWiseRow['drawing']; ?>" required />
																				</div>
																			</td>
																		</tr>
																	</tbody>
															...
															<div class="table-responsive table-card mt-3 mb-1">
																<table class="table align-middle table-nowrap" id="customerTable">
																	...
																	<tbody class="list form-check-all">
																		<td>
																			<div class="form-group" id="">
																				<input type="text" class="form-control" name="currentDate" value="<?php echo $purchaseLotWiseRow['emptyDate']; ?>" required />
																			</div>
																		</td>
																		<td>
																			<div class="form-group" id="">
																				<input type="text" class="form-control" name="emptyNoOfReel" value="<?php echo $purchaseLotWiseRow['emptyNoOfReel']; ?>" required1 />
																			</div>
																		</td>
																		<td>
																			<div class="form-group">
																				<input type="text" class="form-control" id="reelWt" name="reelWt" value="<?php echo $purchaseLotWiseRow['reelWt']; ?>" required oninput="calculateNetWeight()" />
																			</div>
																		</td>
																		<td>
																			<div class="form-group">
																				<input type="text" class="form-control" id="netWeight" name="netWeight" value="<?php echo $purchaseLotWiseRow['netWeight']; ?>" placeholder="Net Weight" readonly />
																			</div>
																		</td>
																		</tr>
																	</tbody>
										...
										<div class="row">
															...
															<div class="table-responsive table-card mt-3 mb-1">
																<table class="table align-middle table-nowrap" id="customerTable">
																	...
																	<tbody class="list form-check-all">
																		<td>
																			<div class="form-group">
																				<input type="text" class="form-control" name="totalAmount" id="totalAmount" value="<?php echo $purchaseLotWiseRow['totalAmount']; ?>" readonly />
																			</div>
																		</td>
																		<td>
																			<div class="form-group">
																				<input type="text" class="form-control" name="interestField" id="interestField" value="<?php echo $purchaseLotWiseRow['interest']; ?>" oninput="calculateNetAmt()" required />
																			</div>
																		</td>

																		<td>
																			<div class="form-group">
																				<input type="text" class="form-control" name="netAmtField" id="netAmtField" value="<?php echo $purchaseLotWiseRow['netAmount']; ?>" readonly />
																			</div>
																		</td>
																		</tr>
																	</tbody>
											...
											<div class="col-sm-12 mt-4 text-center">
												<input type="submit" name="main_submit" class="btn btn-info" value="Update" style="background-color:#0ab39c;">
											</div>
										</div>
									</form>
								</div>
