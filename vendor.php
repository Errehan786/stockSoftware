...
<head>
    <meta charset="utf-8" />
    <title>Vendor | <?php echo $_SESSION['userName']?> </title>
                                            ...
                                            <div class="col-lg-9 col-12">
                                                <div class="d-flex justify-content-end align-items-center h-100">
                                                    <a href="#addNewCategory">
                                                        <button class="btn btn-sm btn-success edit-item-btn"> Add New Vendor</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        <?php while ($row = $result->fetch(PDO::FETCH_ASSOC)) { ?>
                                                           ...
                                                           <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <a href="venderedit.php?id='.$row['id'].'" class="btn btn-sm btn-success edit-item-btn" name="edit_category_item">Edit</a>
                                                            </div>
                                                              <div class="remove">
                                             ...
                                             function dataVdelete<?php echo $row['id'] ?>(rowID){
                                              ...
                                              if(!r){
                                                  return false;
                                                        ...
                                                        var myData = "rid="+rowID+"&action=deleteVendorRow";
                                                        //alert(myData);
                                                         jQuery.ajax({
                        ...
                        <div class="col-xxl-12">
                            <div class="card">
                                <div class="card-header align-items-center d-flex">
                                    <h4 class="card-title mb-0 flex-grow-1">Add New Vendor</h4>
                                </div>
                                <?php if (isset($msg)) {
                                    echo $msg;
                                } ?>
