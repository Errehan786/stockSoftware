...
<head>
<meta charset="utf-8" />
<title>Cash Receipt | <?php echo $_SESSION['userName']?> </title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0">Cash Receipt </h4>
            ...
            <div class="col-xxl-12">
              <div class="card">
                <div class="card-header align-items-center d-flex">
                  <h4 class="card-title mb-0 flex-grow-1">Add Cash Receipt</h4>
                </div>
                <!-- end card header -->
                <div class="card-body">
                      ...
                      <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <td>
                          ...
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" id=""  placeholder="Amount" style="width:260px;"  autocomplete="off" required />
                            </div></td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Remarks" style="width:260px;"   autocomplete="off" required/>
                            </div>
                          </td>
                          <td><div class="d-flex">
                              <div class="edit">
