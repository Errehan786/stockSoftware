...
<head>
<meta charset="utf-8" />
<title>Finished Goods Purchase | <?php echo $_SESSION['userName']?> </title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0">Finished Goods Purchase</h4>
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a> </li>
                  <li class="breadcrumb-item active">Finished Goods Purchase</li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post">
                      ...
                      <div class="col-lg-3">
                        <div class="mb-4">
                          ...
                          <input type="text" class="form-control" name="" placeholder="Enter V.No." id="" required/>
                        </div>
                      </div>
                      <!--end col-->
                      <div class="col-lg-3">
                         ...
                         <td >
                          ...
                          <td>
                            <div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Qty/Pack" style="width: 120px;"  required/>
                            </div>
                          </td>
                          <td>
                            <div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Qty/Unit" style="width: 120px;"  required/>
                            </div>
                          </td>
                          <td>
                            <div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Unit" style="width: 120px;"  required/>
                            </div>
                          </td>
                          <td>
                            <div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Price Unit" style="width: 120px;"  required/>
                            </div>
                          </td>
                          <td>
                            <div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="LR No." style="width: 120px;"  required/>
                            </div>
                          </td>
                          <td> 
                             <div class="form-group" id="">
                              <select id="iteamList0" class="form-select" name="" data-choices data-choices-sorting="true" style="width:220px"  required>
                                ...
                                <option value="">Transport1</option>
                                 <option value="">Transport2</option>
                              </select>
                             </div>
                         </td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Lot No." style="width: 120px;"  required/>
                            </div>
                          </td>
                          <td><div class="d-flex">
                              <div class="edit">
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-4">
                           <div class="row g-3 align-items-center my-4 mb-1">
                             <div class="col-5">
                               <label for="" class="col-form-label">Discount [-]  <input type="number" id="" class="form-control" style="width: 20px;display:inline;"> %</label>
                             </div>
                             <div class="col-7">
                     ...
                     <div class="col-sm-4">
                         <div class="row g-3 align-items-center mb-1">
                             ...
                             <div class="row g-3 align-items-center mb-1">
                             <div class="col-5">
                               <label for="inputPassword6" class="col-form-label">Total  Amount</label>
                             </div>
                             <div class="col-7">
                               <input type="number" id="" class="form-control" aria-describedby="passwordHelpInline">
                             </div>
