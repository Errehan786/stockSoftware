...
if (isset($_REQUEST['searchData'])) {
    ...
    // Base SQL query
    $purchaseSql = "SELECT * FROM `purchaseGoodsRawMaterial` WHERE type='salesFinishedGoods'";
      ...
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0">Finished Goods Sales Report</h4>
            <div class="page-title-right">
              <ol class="breadcrumb m-0">
                <li class="breadcrumb-item">
                  <a href="./dashboard.php">Dashboard</a>
                </li>
                <li class="breadcrumb-item active">Finished Goods Sales Report</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="table-responsive table-card">
                ...
                <div class="row">
                  <div class="col-8 m-2">
                    <h3 class="mb-4">Finished Goods Sales Report</h3>
                  </div>
                  <!-- Export to Excel Button -->
                  <div class="col-3 m-2">
                    <form action="exportToExcelFinishedGoodsSales.php" method="post">
                ...
                <table class="table table-sm table-bordered align-middle">
                  ...
                  <tbody>
                    ...
                    while ($purchaseData = $purchaseSqlResult->fetch(PDO::FETCH_ASSOC)) {
                      $purchaseRawSql = "SELECT * FROM `goodsRawMetrial` WHERE voucherNo='$purchaseData[voucherNo]' and type='salesFinishedGoods'";
