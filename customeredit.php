...
if(isset($_REQUEST['id'])){
   $sql = "SELECT * FROM `customer` WHERE id = {$_REQUEST['id']} and user_reg_id='$_SESSION[id]'";
...
if(isset($_REQUEST['update'])){
    ...
    $id = $_REQUEST['id'];
        $sql = "UPDATE `customer` SET name='$vname', email='$v_email', mobile_no='$v_number', address='$v_address' WHERE id='$id'";
        if($conn->query($sql)){
