...
<head>
    ...
    <meta charset="utf-8" />
    <title>Stock Register | <?php echo $_SESSION['userName']?> </title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Stock Register</h4>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 mb-3  mb-md-0">
                                  ...
                                  <select id="" name="" class="form-select"  required>
                                     ...
                                     <option name="" value=""> Category1</option>
                                     <option name="" value="">Category2</option>
                                     <option name="" value="">Category3</option>
                                  </select>
                                </div>
                            </div>
                        </div>
