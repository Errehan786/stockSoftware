...
///get Voucher , invoice
$voucherSql = "SELECT voucherNo,invoiceNo FROM `SemiMaterialFinal` where type='return' order by id desc";
...
if(isset($_REQUEST['purchaseMetrialSubmit'])){
    ...
    $metrialSql = "INSERT INTO `SemiMaterialFinal`(`partyAccountName`, `accountName`, `voucherNo`, `date`, `invoiceNo`, `addCharges`, `deductionCharge`,`addChargesRemark`,`deductionChargeRemark`, `totalBill`, `remark`,`type`) VALUES ('$partyAccountName','$accountName','$voucherNo','$date','$invoiceNo','$addChargesAmount','$deductionChargeAmount','$addChargesRemark','$deductionChargeRemark','$totalBill','$remark','return')";
    $metrialResult = $conn->exec($metrialSql);
    if($metrialResult == true){
        echo '<script>alert("Data Submited Successfull");location.href="rawSemiPurchaseReturn.php";</script>';
    }else{
    ...
    if (selectedData) {
        ...
        xmlhttp2.onreadystatechange = function () {
            if (xmlhttp2.readyState === 4 && xmlhttp2.status === 200) {
                ...
                var totalBaseQty = xmlhttp2.responseText;
        ...
        // Call the PHP script to get the baseQty, passing the selected description
        xmlhttp2.open("GET", "getBaseQty.php?description=" + encodeURIComponent(selectedDescription) + "&group=" + encodeURIComponent(str), true);
        xmlhttp2.send();
    } else {
        document.querySelector(".rateInput").style.display = "none";
        document.querySelector(".unitInput").style.display = "none";
        document.querySelector(".baseQtyInput").value = ""; // Clear baseQty if no description is selected
    }
});
        }
    };
...
function insertData() {
    ...
    // Convert baseQty and baseQtyInput to numbers for comparison
    var baseQtyNumber = parseFloat(netQty);
    var baseQtyInputNumber = parseFloat(baseQtyInput);

    // Validate baseQty against baseQtyInput
    if (baseQtyNumber > baseQtyInputNumber) {
        alert('Base Qty More Than Of Total Stocks');
        return; // Prevent form submission if baseQty exceeds available stock
    }
    ...
    xhr.send(
        ...
        "&typeIs=" + encodeURIComponent("return") +
...
<head>
    <meta charset="utf-8" />
    <title>Raw/Semi Purchase Return | <?php echo $_SESSION['userName'] ?> </title>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Raw/Semi Purchase Return</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a> </li>
                                        <li class="breadcrumb-item active">Raw/Semi Purchase Return</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                                                        ...
                                                                        <tbody class="list form-check-all">
                                                                            ...
                                                                            <td style="width:200px;padding-left: 0px;">
                                                                                <div>
                                                                                  <div class="form-group" id="textarea1">
                                                                                    <select id="groupSelect" class="form-select border" name="productCat" onChange="showUser1234(this.value)" style="width:150px">
                                                                            ...
                                                                            <td>
                                                                                <div class="form-group txtHint">
                                                                                  <select class="form-select descriptionSelect" name="calDescription" style="width:130px">
                                                                          ...
                                                                          <td>
                                                                            ...
                                                                            <td>
                                                                            <div class="form-group">
                                                                              <input type="text" class="baseQtyInput" style="width: 71px;" readonly />
                                                                            </div>
                                                                          </td>
                                                                            </tr>
    ...
    <div class="col-sm-4">
        <div class="row g-3 align-items-center mb-1">
            ...
            <div class="col-7">
                <input type="text" id="totalAmountBase" class="form-control">
            </div>
        </div>
        <div class="row g-3 align-items-center mb-1">
            <div class="col-5">
