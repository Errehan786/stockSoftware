...
///get Voucher
$voucherSql = "SELECT voucherNo,invoiceNo FROM `SemiMaterialFinal` where type='rawSale' order by id desc";
...
if(isset($_REQUEST['purchaseMetrialSubmit'])){
    ...
    $metrialSql = "INSERT INTO `SemiMaterialFinal`(`partyAccountName`, `accountName`, `voucherNo`, `date`, `invoiceNo`, `addCharges`, `deductionCharge`,`addChargesRemark`,`deductionChargeRemark`, `totalBill`, `remark`,`type`) VALUES ('$partyAccountName','$accountName','$voucherNo','$date','$invoiceNo','$addChargesAmount','$deductionChargeAmount','$addChargesRemark','$deductionChargeRemark','$totalBill','$remark','rawSale')";
    $metrialResult = $conn->exec($metrialSql);
    if($metrialResult == true){
        echo '<script>alert("Data Submited Successfull");location.href="rawsemiMaterialsales.php";</script>';
    }else{
...
function insertData() {
    ...
    var baseQtyNumber = parseFloat(baseQty);
    ...
    xhr.send(
        ...
        "&typeIs=" + encodeURIComponent("rawSale") +
...
<head>
    <meta charset="utf-8" />
    <title>Raw Seles | <?php echo $_SESSION['userName'] ?> </title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Raw Seles</h4>
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a> </li>
                                        <li class="breadcrumb-item active">Raw Seles</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
