...
<head>
    ...
    <meta charset="utf-8" />
    <title>Product Ledger - Metal | <?php echo $_SESSION['userName']?> </title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Product Ledger - Metal</h4>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 mb-3  mb-md-0">
                                  ...
                                  <select id="" name="" class="form-select"  required>
                                     ...
                                     <option name="" value="">Metal1</option>
                                     <option name="" value="">Metal2</option>
                                     <option name="" value="">Metal3</option>
                                  </select>
                                </div>
                                 <div class="col-12 col-lg-4 mb-3  mb-md-0">
                                   <label class="form-label">Guage</label>
                                  <select id="" name="" class="form-select"  required>
                                      <option value="">Select Guage</option>
                                     <option name="" value="">Guage1</option>
                                     <option name="" value="">Guage</option>
                                     <option name="" value="">Guage3</option>
                                  </select>
                                </div>
