...
<head>
    ...
    <meta charset="utf-8" />
    <title>Raw Purchases Return Book | <?php echo $_SESSION['userName']?> </title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Raw Purchases Return Book</h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                        ...
                        <h5>Raw Purchases Return Book</h5>
                    <hr>
                </div>
            </div>
