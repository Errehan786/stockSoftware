                                    ...
                                    <div class="col-12">
                                        <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                            <div class="flex-grow-1">
                                                <h4 class="fs-16 mb-1">Hi, <?php echo ₹_SESSION['userName']?>!</h4>
                                            </div>
                                        </div>
                                        <!-- end card header -->
                                    </div>
                                    ...
                                    <div class="col-xl-12">
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">Purchased Items Record</h4>
                                                <div class="flex-shrink-0">
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>ABC Pvt Ltd.</td>
                                                                <td>
                                                                    <span class="text-success">24 Aug 2022</span>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <span
                                                                        class="badge badge-soft-success d-none">Active</span>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <span
                                                                        class="badge badge-soft-danger d-none">Closed</span>
                                                                </td>
