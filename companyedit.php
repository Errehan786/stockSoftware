...
if(isset($_REQUEST['update'])){
    ...
    $id = $_REQUEST['id'];
        $sql = "UPDATE `company` SET pass='$pass',password='$password',name='$vname', email='$v_email', mobile_no='$v_number', address='$v_address', remark='$v_remark' WHERE id='$id'";
        if($conn->query($sql)){
            ...
            setTimeout(
                function(){
                    window.location = "create-company.php"; 
                },
            1000);
            </script>
            <?php
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="v_password" class="form-control" class="form-control" value="<?php if(isset($row['pass'])){echo $row['pass'];}?>">
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="v_remark" value="<?php if(isset($row['remark'])){echo $row['remark'];}?>"
                                                            placeholder="Enter Weight Of Each Unit" />
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="col-lg-12">
                                                    <div class="text-center">
                                                        ...
                                                        <a href="create-company.php" class="btn btn-info">Back</a>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                            </div>
