...
if(isset($_REQUEST['formulaedit'])){
    $sql7 = "SELECT * FROM `formula_sub_items` WHERE id = {$_REQUEST['formulaedit']}";
...
if(isset($_REQUEST['subFormulaUpdate'])){
            ...
            $p_item = $_REQUEST['p_item'];
            $sql1 = "UPDATE `formula_sub_items` SET `category`='$p_category', `Item`='$p_item', `qty`='$formula_Qty' WHERE id={$_REQUEST['formulaedit']}";
            if($conn->query($sql1)){
...
if(isset($_REQUEST['deletes'])){
    $sql = "DELETE FROM formula_entry WHERE id={$_REQUEST['deletes']}";
                                                            ...
                                                            <tbody class="list form-check-all">
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <?php
                                                                            $categoryName =  $row7['category'];
                                                                            $itemId = $row7['id'];
                                                                            $sql4 = "SELECT * FROM `category` where user_reg_id='$_SESSION[id]'";
                                                                            $result4 = $conn->query($sql4);
                                                                            ?>
                                                                            <select id="ForminputState" name="p_category" class="form-select" data-choices data-choices-sorting="true">
                                                                                <?php
                                                                                while($row2 = $result4->fetch(PDO::FETCH_ASSOC)){
                                                                                ?>
                                                                                <option value="<?php echo $row2['id'] ?>" <?php if($row2['id']==$row7['category'])echo "selected"?>><?php if(isset($row2['Category_Name'])){echo $row2['Category_Name'];}?></option>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                            </select>
                                                                    ...
                                                                    <td>
                                                                        <div class="mb-3" id="item_name">
                                                                            ...
                                                                            ?>
                                                                            <select id="ForminputState" name="p_item" class="form-select" data-choices
                                                                                data-choices-sorting="true">
                                                                                <?php
                                                                                while($row1 = $result3->fetch(PDO::FETCH_ASSOC)){
                                                                                ?>
                                                                                <option value="<?php echo $row1['id']?>"<?php if($row1['id']==$row7['Item']) echo "selected"?>><?php if(isset($row1['item_name'])){echo $row1['item_name'];}?></option>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                            </select>
                                                                    ...
                                                                    <td>
                                                                        <div class="mb-3" id="formula_qty">     
                                                                            <input type="text" class="form-control" name="formulaQty" value="<?php if(isset($row7['qty'])){echo $row7['qty'];}?>" placeholder="Enter Qty" id="compnayNameinput" />
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
