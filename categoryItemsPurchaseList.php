                            ...
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Category items Purchase List</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row g-4 mb-4">
                                            ...
                                            <div class="col-lg-9 col-12">
                                                <div class=" d-flex justify-content-end h-100 align-items-center">
                                                    <a href="#addNewItem"> <button class="btn btn-sm btn-success edit-item-btn"> Add New Items</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <tbody class="list form-check-all">
                                                    <?php 
                                                      while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                                        ...
                                                        $itemId = $row['id'];
                                                        $sql3 = "SELECT name FROM `vendor` WHERE id='$vendorId'";
                                                        $result3 = $conn->query($sql3);
                                                        $row1 = $result3->fetch(PDO::FETCH_ASSOC);

                                                            $categoryId =  $row['category'];
                                                            //$itemId = $row['id'];
                                                            $sql4 = "SELECT Category_Name FROM `category` WHERE id='$categoryId'";
                                                    ...
                                                    <tr id="messageTxtHide<?php echo $row['id']?>">
                                                        ...
                                                        echo '<td>' . $row['weight_unit'] . '</td>';
                                                        echo '<td>
                                                           <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <a href="categoryitemedit.php?edit_category_item='. $itemId ."&gf". $vendorId .'" class="btn btn-sm btn-success edit-item-btn" name="edit_category_item">Edit</a>
                                                            </div>
                                                            <div class="remove">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="item_code"
                                                            placeholder="Enter Item Code" autocomplete="off" required/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        <label class="form-label">Name of Item
                                                        </label>
                                                        <input type="text" class="form-control" name="item_name" placeholder="Enter Item Name" autocomplete="off" required/>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class=" mb-3">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="vendorList" name="vendor_name" class="form-select" onChange="createVendor(this.value)" required>
                                                            ...
                                                            while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                                            ?>
                                                            <option name ="category_ids" value="<?php echo $row['id'];?>"><?php if(isset($row['name'])){echo $row['name'];}?></option>
                                                            <?php } 
                                                            echo '<optgroup label="For a new vendor"></optgroup><option>Add New</option>';
                                                            ?>
                                                        </select>
                                                        ...
                                                        <script>
                                                            function createVendor(getVType){
                                                                if(getVType=="Add New"){
                                                                  $("#addNewVendor").addClass("show");
                                                                  document.getElementById("addNewVendor").style.display="block";
                                                                }
                                                            }
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="category" name="category" class="form-select" onChange="createCategory(this.value)" required>
                                                            <option value="">Select Category</option>
                                                            <?php
                                                            while($row = $result->fetch(PDO::FETCH_ASSOC)){
                                                            if($row['percentage']=="Yes")$pr="(In %)";else $pr='';     
                                                            ?>
                                                            <option value="<?php echo $row['id'];?>"><?php if(isset($row['Category_Name'])){echo $row['Category_Name']." - ".$row['Measuring_Units'].$pr;}?></option>
                                                            <?php }
                                                            echo '<optgroup label="For a new category"></optgroup><option>Add New</option>';
                                                        ?>
                                                        </select>
                                                        
                                                        <script>
                                                            function createCategory(getVType){
                                                                if(getVType=="Add New"){
                                                                  $("#addNewCategory").addClass("show");
                                                                  document.getElementById("addNewCategory").style.display="block";
                                                                }else{
                                                              
                                                              
                                                              
                                                                //get unit list and unit per wt
                                                                var myData = "categoryID="+getVType+'&action=getUnit';
                                                                    jQuery.ajax({
		                                                          	type: "POST", // HTTP method POST or GET
			                                                         url: "action.php", //Where to make Ajax calls
		                                                               dataType:"text", // Data type, HTML, json etc.
		                                                               data:myData, //Form variables
	                                                                success:function(response){
	                                                                   document.getElementById('weightEachUnit').innerHTML = response;
	                                                                },
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="location" placeholder="Enter Location Name" autocomplete="off" />
                                                    </div>
                                                </div>
                                                <div id="weightEachUnit" style="display: flex;padding-left: 15px;"></div>
