...
<head>
<meta charset="utf-8" />
<title>Raw Material Purchase Return | <?php echo $_SESSION['userName']?> </title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0">Raw Material Purchase Return</h4>
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a> </li>
                  <li class="breadcrumb-item active">Raw Material Purchase Return </li>
                </ol>
              </div>
            </div>
          </div>
                      ...
                      <tbody class="list form-check-all">
                        ...
                        <td>400</td>
                           <td> <div class="d-flex gap-2">
                                <div class="view mx-2">
                              <a href="rawMaterialpurchasereturnsview.php" class="btn btn-sm bg-info edit-item-btn text-white">View</a>
                            </div>
                            <div class="edit mx-2">
