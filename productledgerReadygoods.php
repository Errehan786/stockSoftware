...
<head>
    ...
    <meta charset="utf-8" />
    <title>Product Ledger - Ready Goods | <?php echo $_SESSION['userName']?> </title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Product Ledger - Ready Goods</h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                        ...
                        <h5>Product Ledger - Ready Goods</h5>
                    <hr>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 mb-3  mb-md-0">
                                  ...
                                  <select id="" name="" class="form-select"  required>
                                     ...
                                     <option name="" value="">Product Category1</option>
                                     <option name="" value="">Product Category2</option>
                                     <option name="" value="">Product Category3</option>
                                  </select>
                                </div>
                                 <div class="col-12 col-lg-4 mb-3  mb-md-0">
                                  ...
                                  <select id="" name="" class="form-select"  required>
                                     ...
                                     <option name="" value="">Product Description1</option>
                                     <option name="" value="">Product Description2</option>
                                     <option name="" value="">Product Description3</option>
                                  </select>
                                </div>
