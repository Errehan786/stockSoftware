...
<head>
    ...
    <meta charset="utf-8" />
    <title>Cable Production Report | <?php echo $_SESSION['userName']?> </title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Cable Production Report</h4>
