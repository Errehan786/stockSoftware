...
<head>
    ...
    <meta charset="utf-8" />
    <title>Manufacturing Report | <?php echo $_SESSION['userName']?> </title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">MANUFACTURING RFEPORT</h4>
                                ...
                                <div id="customerList">
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-2">
                                            <h5>Manufacturing Current Details </h5>
                                            <hr>
                                        </div>
                                    ...
                                    <div class="row  mb-4">
                                        ...
                                        <div
                                            ...
                                            <a href="#addNewPurchase"> <button class="btn btn-sm btn-success edit-item-btn"> 
                                        ...
                                        <table class="table align-middle table-nowrap" id="customerTable">
                                            ...
                                            <tbody class="list form-check-all">
                                                <tr>
                                                    ...
                                                    <td><span class="badge badge-soft-success text-uppercase">Active</span>
                                                        <span class="d-none badge badge-soft-danger text-uppercase">Closed</span>
                                                    </td>
                                                    <td>$ 20,000</td>
