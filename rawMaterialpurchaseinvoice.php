...
<head>
<meta charset="utf-8" />
<title>Raw Material Purchase Invoice | <?php echo $_SESSION['userName']?> </title>
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0">Raw Material Purchase Invoice</h4>
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a> </li>
                  <li class="breadcrumb-item active">Raw Material Purchase Invoice </li>
                </ol>
              </div>
            </div>
          </div>
                      ...
                      <tbody class="list form-check-all">
                        ...
                        <td>400</td>
                           <td> <div class="d-flex gap-2">
                                <div class="view mx-2">
                              <a href="rawMaterialpurchaseinvoiceview.php" class="btn btn-sm bg-info edit-item-btn text-white">View</a>
                            </div>
                            <div class="edit mx-2">
                      ...
                      <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <td style="width:260px;padding-left: 0px;">
                          ...
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" id="" style="width: 120px;" placeholder="Base Qty" autocomplete="off" required />
                            </div></td>
                          <td>
                          <div class="form-group" id="">
                              <select id="iteamList0" class="form-select" name="" data-choices data-choices-sorting="true" style="width:220px" required>
                                <option value="">Select Container Type</option>
                                <option value="">Container1</option>
                                 <option value="">Container2</option>
                              </select>
                            </div></td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" id="" style="width: 120px;" placeholder="Content" autocomplete="off" required />
                            </div></td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Net Qty" style="width: 120px;" autocomplete="off" required/>
                            </div>
                          </td>
                           <td><div class="form-group" id="">
