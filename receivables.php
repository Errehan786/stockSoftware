...
<head>
    ...
    <meta charset="utf-8" />
    <title>Receivables | <?php echo $_SESSION['userName']?> </title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Receivables</h4>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                        ...
                        <h5>Receivables (Sundry Debtors)</h5>
                    <hr>
                </div>
            </div>
                    ...
                    <div class="row g-4 mb-4">
                        <div
                            class="col-lg-12 col-12 d-flex align-items-center justify-content-lg-end justify-content-center">
