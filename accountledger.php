...
<head>
    ...
    <meta charset="utf-8" />
    <title>Account Ledger | <?php echo $_SESSION['userName']?> </title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Account Ledger</h4>
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                <tr>
                                    ...
                                    <td>₹400</td>
                                    <td>₹4000</td>
                                    <td>Lorem ipsum dolo cum quia!</td>
                                </tr>
                                 <tr>
                                    <td>2</td>
                                    <td>22 March 2022 </td>
                                  ...
                                  <tr>
                                   ...
                                   <tr>
                                    ...
                                    <td>Total Amount</td>
                                    <td>
                                        <input type="text" class="form-control" data-provider="flatpickr" id="" style="width:122px;"/>
                                    </td>
                                     <td>
                                        <input type="text" class="form-control" data-provider="flatpickr" id="" style="width:122px;"/>
                                    </td>
