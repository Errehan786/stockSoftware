...
///get Voucher , invoice
$voucherSql = "SELECT voucherNo FROM `purchaseGoodsRawMaterial` where type='purchaseFinishedGoods' order by id desc";
...
if (isset($_REQUEST["purchaseGoodsMetrialSubmit"])) {
    ...
    $purchaseFinishedGoods = 'purchaseFinishedGoods';
    $metrialSql = "INSERT INTO `purchaseGoodsRawMaterial`(`partyAccountName`, `accountName`, `voucherNo`, `date`, `totalAmount`, `discountPer`, `addChargeAmount`, `dudChargeAmount`, `addChargeRemark`, `dudChargeRemark`, `totalBill`, `remark`,`type`) VALUES ('$partyAccountName','$accountName','$voucherNo','$date','$totalAmountBase','$addChargesPercentage','$addChargesAmount','$deductionChargeAmount','$addChargesRemark','$deductionChargeRemark','$totalBill','$remark','$purchaseFinishedGoods')";
    $metrialResult = $conn->exec($metrialSql);
    if ($metrialResult == true) {
        echo '<script>alert("Data Submited Successfull");location.href="finishedGoodsPurchase.php";</script>';
    } else {
...
function insertData() {
    ...
    xhr.send(
        ...
        "&purchaseFinishedGoods=" + encodeURIComponent("purchaseFinishedGoods") +
                                                                ...
                                                                <div class="table-responsive table-card mt-3 mb-1">
                                                                    <table class="table align-middle table-nowrap" id="itemTable">
                                                                        ...
                                                                        <tbody class="list form-check-all">
                                                                            ...
                                                                            <td>
                                                                              <div class="form-group">
                                                                                <input type="text" class="form-control" id="length" name="length" placeholder="Length" style="width: 120px;" />
                                                                              </div>
                                                                            </td>
                                                                            <td>
                                                                              <div class="form-group">
                                                                                <input type="number" class="form-control" id="qtyPack" name="qtyPack" placeholder="Qty/Pack" style="width: 120px;" oninput="calculateNetQty()" />
                                                                              </div>
                                                                            </td>
                                                                            <td>
                                                                              <div class="form-group">
                                                                                <input type="number" class="form-control" id="totalQty" name="totalQty" placeholder="Total Qty" style="width: 120px;" readonly/>
                                                                              </div>
                                                                            </td>
                                                                            <td>
                                                                            <div class="form-group">
