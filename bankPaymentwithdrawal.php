...
<head>
<meta charset="utf-8" />
<title>Bank Payment / Withdrawal | <?php echo $_SESSION['userName']?> </title>
...
<script>
        ...
        $(add_button1).click(function(e){
            ...
            if(x < max_fields1){ 
                x++; 
                $(wrapper1).append('<div class="d-flex gap-2"><tbody class="list form-check-all"> <tr><td> <div class="form-group" id="textarea1"> <select id="iteamList0" class="form-select" name="" data-choices="" data-choices-sorting="true" style="width:260px;" required=""> <option value="">Select Account</option> <option value="">Account 1</option> <option value="">Account 2</option> </select> </div> </td> <td><div class="form-group" id=""> <input type="text" class="form-control" name="" id="" placeholder="Amount" style="width:200px;" autocomplete="off" required=""> </div></td> <td><div class="form-group" id=""> <input type="text" class="form-control" name="" placeholder="Remarks" style="width:200px;" autocomplete="off" required=""> </div> </td> <td><div class="form-group" id=""> <input type="text" class="form-control" name="" placeholder="Chq No." style="width:200px;" autocomplete="off" required=""> </div> </td> </tr> </tbody><a class="btn btn-sm btn-success edit-item-btn add_form_field1 delete">Remove</a></div>'); 
               //alert('Fields added');
            }
        ...
        <div class="row">
          <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
              <h4 class="mb-sm-0">Bank Payment / Withdrawal</h4>
              <div class="page-title-right">
                <ol class="breadcrumb m-0">
                  <li class="breadcrumb-item"><a href="./dashboard.php">Dashboard</a> </li>
                  <li class="breadcrumb-item active">Bank Payment / Withdrawal</li>
                </ol>
              </div>
            </div>
          </div>
                  ...
                  <div class="table-responsive">
                    <table class="table align-middle table-nowrap" id="customerTable">
                      ...
                      <tbody class="list form-check-all">
                        ...
                        <td></td>
                         <td>Total Amount</td>
                        <td><input type="text" class="form-control" data-provider="flatpickr" id="" style="width:122px;"></td>
                           <td> 
                           </td>
                        </tr>
                      </tbody>
            ...
            <div class="col-xxl-12">
              <div class="card">
                <div class="card-header align-items-center d-flex">
                  <h4 class="card-title mb-0 flex-grow-1">Add Bank Payment / Withdrawal</h4>
                </div>
                <!-- end card header -->
                <div class="card-body">
                  <div class="live-preview">
                    <form action="" method="post">
                      <div class="row">
                        <div class="col-lg-3">
                        <div class="mb-4">
                          <label for="" class="form-label">Vocher No.</label>
                      ...
                      <div class="col-lg-3">
                        <div class="mb-4">
                          ...
                          <select id="vendorList" name="vendor_name" class="form-select" onChange="createVendor(this.value)" required>
                            ...
                            <option name="" value="">SBI</option>
                            <option name="" value="">HDFC</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-lg-3">
                      ...
                      <table class="table align-middle table-nowrap" id="customerTable">
                        ...
                        <td>
                            <div class="form-group" id="textarea1">
                              <select id="iteamList0" class="form-select" name="" data-choices data-choices-sorting="true" style="width:260px;"  required>
                          ...
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" id=""  placeholder="Amount" style="width:200px;"  autocomplete="off" required />
                            </div></td>
                          <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Remarks" style="width:200px;"   autocomplete="off" required/>
                            </div>
                          </td>
                            <td><div class="form-group" id="">
                              <input type="text" class="form-control" name="" placeholder="Chq No." style="width:200px;"   autocomplete="off" required/>
                            </div>
                          </td>
                          <td><div class="d-flex">
                              <div class="edit">
